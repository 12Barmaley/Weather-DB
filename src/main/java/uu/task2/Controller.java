...
import uu.task2.enums.Functionality;
...
public class Controller {
    ...
    public Controller() {
        ...
        variantResult.put(3, Functionality.GET_DB_INFO);
    }
    ...
    public void getWeatherFromDb() throws IOException, SQLException {
        new ConsoleWeatherRender(databaseRepository.getAllSavedData()).getWeatherFromDb();
    }
}
